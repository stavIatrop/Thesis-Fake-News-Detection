...
#Load train data
X = pd.read_csv("train_politifact_vol2.csv", ",")
Y = X['label'].values
X = X['text'].values
...
accuracy_knn = np.zeros((10, 71))
f1_knn = np.zeros((10, 71))

accuracy_LR = np.zeros((10, 71))
f1_LR = np.zeros((10, 71))

accuracy_DT = np.zeros((10, 71))
f1_DT = np.zeros((10, 71))

accuracy_RF = np.zeros((10, 71))
f1_RF = np.zeros((10, 71))

accuracy_svm = np.zeros((10, 71))
f1_svm = np.zeros((10, 71))
