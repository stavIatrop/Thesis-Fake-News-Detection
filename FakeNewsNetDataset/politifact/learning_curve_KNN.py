...
# x = [1, 2]
# train_scores, valid_scores = validation_curve(KNeighborsClassifier(n_neighbors= 1), X_train, y_train, "weights", ['uniform', 'distance'], cv=5, verbose=1000, n_jobs=-1, scoring='f1')
...
# x = [1, 2]
# train_scores, valid_scores = validation_curve(KNeighborsClassifier(n_neighbors=1), X_train, y_train, "metric", ['euclidean', 'manhattan'], cv=5, verbose=1000, n_jobs=-1, scoring='f1')
...
# x = range(3, 11)
# train_scores, valid_scores = validation_curve(KNeighborsClassifier(n_neighbors=1, metric='minkowski'), X_train, y_train, "p", x, cv=5, verbose=1000, n_jobs=-1, scoring='f1')
...
x = [1, 2, 3, 4]
train_scores, valid_scores = validation_curve(KNeighborsClassifier(n_neighbors=1, metric='minkowski', p=4), X_train, y_train, "algorithm", ['auto', 'ball_tree', 'kd_tree', 'brute'], cv=5, verbose=1000, n_jobs=-1, scoring='f1')
