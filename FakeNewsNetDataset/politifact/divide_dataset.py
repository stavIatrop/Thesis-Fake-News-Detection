...
X = pd.read_csv("stemmed_politifact.csv", ",", usecols=['id', 'text', 'label'])
...
df_train.to_csv('train_politifact.csv',sep=',',index = False ,header = False)
print("train made.")
df_dev = pd.DataFrame(list_dev)
df_dev.to_csv('dev_politifact.csv',sep=',',index = False ,header = False)
print("dev made.")
df_test = pd.DataFrame(list_test)
df_test.to_csv('test_politifact.csv',sep=',',index = False ,header = False)
print("test made.")
