...
x = [1, 2, 3, 4, 5]
train_scores, valid_scores = validation_curve(LogisticRegression(), X_train, y_train, "solver", ['newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'] ,   cv=3 , verbose=1000, n_jobs=-1, scoring='f1')
