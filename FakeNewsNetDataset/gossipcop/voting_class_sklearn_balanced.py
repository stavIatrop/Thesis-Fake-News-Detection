...
#Load test data
X_test_origin = pd.read_csv("test_gossipcop_balanced.csv", ",")
...
VC = VotingClassifier(estimators=[('svm', svm), ('KNN', KNN), ('LR', LR), ('DT', DT), ('RF', RF)], voting='soft', weights=[2.02974668, 7.84301111, 0.27950569, 0.09703394, 4.58019984])
