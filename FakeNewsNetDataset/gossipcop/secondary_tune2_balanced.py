...
#Load train data
X = pd.read_csv("train_gossipcop_balanced.csv", ",")
Y = X['label'].values
X = X['text'].values
...
plt.savefig('svm_graph_balanced.png',bbox_inches='tight')
...
plt.grid(True)
plt.legend(loc='upper right')
plt.savefig('LR_graph_balanced.png',bbox_inches='tight')
...
plt.grid(True)
plt.legend(loc='upper right')
plt.savefig('DT_graph_balanced.png',bbox_inches='tight')
...
plt.grid(True)
plt.legend(loc='upper right')
plt.savefig('KNN_graph_balanced.png',bbox_inches='tight')
...
plt.grid(True)
plt.legend(loc='upper right')
plt.savefig('RF_graph_balanced.png',bbox_inches='tight')