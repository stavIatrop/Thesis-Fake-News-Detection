...
#     clf = LogisticRegression(C = 10, penalty='l2', solver='liblinear', max_iter=1000, random_state=42)
#     clf.fit(X_train,Y_train)
#     Y_predicted = clf.predict(X_test)
...
for train, test in kf.split(X):
    ...
    #clf = RandomForestClassifier(criterion='gini', max_depth=25, min_samples_split=30, n_estimators=100, random_state=42) 
