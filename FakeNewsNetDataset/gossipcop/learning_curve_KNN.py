...
# x = [1, 2, 3, 4]
# train_scores, valid_scores = validation_curve(KNeighborsClassifier( metric='minkowski', p=6), X_train, y_train, "algorithm", ['auto', 'ball_tree', 'kd_tree', 'brute'],   cv = 3, verbose=1000, n_jobs=-1, scoring='f1')
