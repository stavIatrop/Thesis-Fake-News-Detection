...
knn = KNeighborsClassifier(n_neighbors = 4, weights='distance', metric='minkowski' ,p = 6)
...
X_meta_train = np.concatenate((Y_class1_train_svm, Y_class1_train_knn, Y_class1_train_LR, Y_class1_train_DT, Y_class1_train_DT), axis=1)  #concatenate horizontally, final shape (m, 5)
